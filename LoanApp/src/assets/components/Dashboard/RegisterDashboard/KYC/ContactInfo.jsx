...
const ContactInfo =(props)=>{
    return (
        ...
        <ContactStatus>
        <StatusRow>
                <StatusImage src={(props.status)? active : inactive} alt={active}>
                </StatusImage>
                <StausText>Contact Information</StausText>
            </StatusRow>
            <StatusRow>
            <StatusImage src={(props.status2)? active : inactive} alt={active}>
                </StatusImage>
                <StausText>Employement Status</StausText>
            </StatusRow>
            <StatusRow>
            <StatusImage src={(props.status3)? active : inactive} alt={active}>
                </StatusImage>
                <StausText>Government Issue ID</StausText>
            </StatusRow>
            <StatusRow>
            <StatusImage src={(props.status4)? active : inactive} alt={active}>
                </StatusImage>
                <StausText>Income Status</StausText>
            </StatusRow>
            <StatusRow>
            <StatusImage src={(props.status5)? active : inactive} alt={active}>
                </StatusImage>
                <StausText>Proof of Address</StausText>
            </StatusRow>
            <StatusRow>
            <StatusImage src={(props.status6)? active : inactive} alt={active}>
                </StatusImage>
